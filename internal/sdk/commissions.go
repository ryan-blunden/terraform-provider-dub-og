...
// ListCommissions - Get commissions for a program.
// Retrieve a list of commissions for a program.
func (s *Commissions) ListCommissions(ctx context.Context, request operations.ListCommissionsRequest, opts ...operations.Option) (*operations.ListCommissionsResponse, error) {
...
// UpdateCommission - Update a commission.
// Update an existing commission amount. This is useful for handling refunds (partial or full) or fraudulent sales.
func (s *Commissions) UpdateCommission(ctx context.Context, request operations.UpdateCommissionRequest, opts ...operations.Option) (*operations.UpdateCommissionResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.UpdateCommissionResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
