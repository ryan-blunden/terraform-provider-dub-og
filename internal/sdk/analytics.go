...
// RetrieveAnalytics - Retrieve analytics for a link, a domain, or the authenticated workspace.
// Retrieve analytics for a link, a domain, or the authenticated workspace. The response type depends on the `event` and `type` query parameters.
func (s *Analytics) RetrieveAnalytics(ctx context.Context, request operations.RetrieveAnalyticsRequest, opts ...operations.Option) (*operations.RetrieveAnalyticsResponse, error) {
