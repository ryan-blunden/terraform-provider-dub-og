...
func (s *Folders) CreateFolder(ctx context.Context, request *operations.CreateFolderRequest, opts ...operations.Option) (*operations.CreateFolderResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.FolderSchema
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.FolderSchema = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// ListFolders - Retrieve a list of folders
// Retrieve a list of folders for the authenticated workspace.
func (s *Folders) ListFolders(ctx context.Context, request operations.ListFoldersRequest, opts ...operations.Option) (*operations.ListFoldersResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
...
func (s *Folders) UpdateFolder(ctx context.Context, request operations.UpdateFolderRequest, opts ...operations.Option) (*operations.UpdateFolderResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
...
func (s *Folders) DeleteFolder(ctx context.Context, request operations.DeleteFolderRequest, opts ...operations.Option) (*operations.DeleteFolderResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
