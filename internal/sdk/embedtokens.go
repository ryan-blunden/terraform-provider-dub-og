...
// CreateReferralsEmbedToken - Create a referrals embed token
// Create a referrals embed token for the given partner/tenant.
func (s *EmbedTokens) CreateReferralsEmbedToken(ctx context.Context, request *operations.CreateReferralsEmbedTokenRequest, opts ...operations.Option) (*operations.CreateReferralsEmbedTokenResponse, error) {
	...
	res := &operations.CreateReferralsEmbedTokenResponse{
