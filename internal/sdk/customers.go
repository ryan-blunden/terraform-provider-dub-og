...
// GetCustomers - Retrieve a list of customers
...
func (s *Customers) DeleteCustomer(ctx context.Context, request operations.DeleteCustomerRequest, opts ...operations.Option) (*operations.DeleteCustomerResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
