...
type BulkCreateLinksTestVariant struct {
	URL        string  `json:"url"`
	Percentage float64 `json:"percentage"`
}

func (o *BulkCreateLinksTestVariant) GetURL() string {
	if o == nil {
		return ""
	}
	return o.URL
...
func (o *BulkCreateLinksTestVariant) GetPercentage() float64 {
	if o == nil {
		return 0.0
	}
	return o.Percentage
...
type RequestBody struct {
	...
	TestVariants []BulkCreateLinksTestVariant `json:"testVariants,omitempty"`
...
func (o *RequestBody) GetGeo() *shared.LinkGeoTargeting {
	if o == nil {
		return nil
	}
	return o.Geo
...
func (o *RequestBody) GetTestVariants() []BulkCreateLinksTestVariant {
	if o == nil {
		return nil
	}
...
type BulkCreateLinksResponseBodyType string

const (
	BulkCreateLinksResponseBodyTypeLinkSchema      BulkCreateLinksResponseBodyType = "LinkSchema"
	BulkCreateLinksResponseBodyTypeLinkErrorSchema BulkCreateLinksResponseBodyType = "LinkErrorSchema"
)

type BulkCreateLinksResponseBody struct {
	LinkSchema      *shared.LinkSchema      `queryParam:"inline"`
	LinkErrorSchema *shared.LinkErrorSchema `queryParam:"inline"`

	Type BulkCreateLinksResponseBodyType
}

func CreateBulkCreateLinksResponseBodyLinkSchema(linkSchema shared.LinkSchema) BulkCreateLinksResponseBody {
	typ := BulkCreateLinksResponseBodyTypeLinkSchema

	return BulkCreateLinksResponseBody{
		LinkSchema: &linkSchema,
		Type:       typ,
	}
}

func CreateBulkCreateLinksResponseBodyLinkErrorSchema(linkErrorSchema shared.LinkErrorSchema) BulkCreateLinksResponseBody {
	typ := BulkCreateLinksResponseBodyTypeLinkErrorSchema
...
func (u *BulkCreateLinksResponseBody) UnmarshalJSON(data []byte) error {

	var linkErrorSchema shared.LinkErrorSchema = shared.LinkErrorSchema{}
	if err := utils.UnmarshalJSON(data, &linkErrorSchema, "", true, true); err == nil {
		u.LinkErrorSchema = &linkErrorSchema
		u.Type = BulkCreateLinksResponseBodyTypeLinkErrorSchema
		return nil
	}

	var linkSchema shared.LinkSchema = shared.LinkSchema{}
	if err := utils.UnmarshalJSON(data, &linkSchema, "", true, true); err == nil {
		u.LinkSchema = &linkSchema
		u.Type = BulkCreateLinksResponseBodyTypeLinkSchema
		return nil
	}

	return fmt.Errorf("could not unmarshal `%s` into any supported union types for BulkCreateLinksResponseBody", string(data))
}

func (u BulkCreateLinksResponseBody) MarshalJSON() ([]byte, error) {
	if u.LinkSchema != nil {
	...
	return nil, errors.New("could not marshal union type BulkCreateLinksResponseBody: all fields are null")
}
...
type BulkCreateLinksResponse struct {
	...
	// The created links
	ResponseBodies []BulkCreateLinksResponseBody
...
func (o *BulkCreateLinksResponse) GetContentType() string {
	if o == nil {
		return ""
	}
...
func (o *BulkCreateLinksResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *BulkCreateLinksResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
...
func (o *BulkCreateLinksResponse) GetResponseBodies() []BulkCreateLinksResponseBody {
	if o == nil {
		return nil
	}
...
func (o *BulkCreateLinksResponse) GetFourHundred() *shared.FourHundred {
	if o == nil {
		return nil
	}
...
func (o *BulkCreateLinksResponse) GetFourHundredAndOne() *shared.FourHundredAndOne {
	if o == nil {
		return nil
	}
...
func (o *BulkCreateLinksResponse) GetFourHundredAndThree() *shared.FourHundredAndThree {
	if o == nil {
		return nil
	}
...
func (o *BulkCreateLinksResponse) GetFourHundredAndFour() *shared.FourHundredAndFour {
	if o == nil {
		return nil
	}
...
func (o *BulkCreateLinksResponse) GetFourHundredAndNine() *shared.FourHundredAndNine {
	if o == nil {
		return nil
	}
...
func (o *BulkCreateLinksResponse) GetFourHundredAndTen() *shared.FourHundredAndTen {
	if o == nil {
		return nil
	}
...
func (o *BulkCreateLinksResponse) GetFourHundredAndTwentyTwo() *shared.FourHundredAndTwentyTwo {
	if o == nil {
		return nil
	}
...
func (o *BulkCreateLinksResponse) GetFourHundredAndTwentyNine() *shared.FourHundredAndTwentyNine {
	if o == nil {
		return nil
	}
...
func (o *BulkCreateLinksResponse) GetFiveHundred() *shared.FiveHundred {
	if o == nil {
		return nil
	}
