...
// GetTagsSortBy - The field to sort the tags by.
type GetTagsSortBy string

const (
	GetTagsSortByName      GetTagsSortBy = "name"
	GetTagsSortByCreatedAt GetTagsSortBy = "createdAt"
)
...
// GetTagsSortOrder - The order to sort the tags by.
type GetTagsSortOrder string

const (
	GetTagsSortOrderAsc  GetTagsSortOrder = "asc"
	GetTagsSortOrderDesc GetTagsSortOrder = "desc"
)

func (e GetTagsSortOrder) ToPointer() *GetTagsSortOrder {
	return &e
}
func (e *GetTagsSortOrder) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "asc":
		fallthrough
	case "desc":
		*e = GetTagsSortOrder(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetTagsSortOrder: %v", v)
	}
}
...
type GetTagsRequest struct {
	...
	SortBy *GetTagsSortBy `default:"name" queryParam:"style=form,explode=true,name=sortBy"`
	// The order to sort the tags by.
	SortOrder *GetTagsSortOrder `default:"asc" queryParam:"style=form,explode=true,name=sortOrder"`
...
func (o *GetTagsRequest) GetSortBy() *GetTagsSortBy {
	if o == nil {
		return nil
	}
	return o.SortBy
...
func (o *GetTagsRequest) GetSortOrder() *GetTagsSortOrder {
	if o == nil {
		return nil
	}
	return o.SortOrder
