...
// GetQRCode - Retrieve a QR code
// Retrieve a QR code for a link.
func (s *QRCodes) GetQRCode(ctx context.Context, request operations.GetQRCodeRequest, opts ...operations.Option) (*operations.GetQRCodeResponse, error) {
